...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _srcIndexJs = __webpack_require__(5);
	
	var _libBaseAction = __webpack_require__(97);
	
	var _libBaseAction2 = _interopRequireDefault(_libBaseAction);
	
	var _immutable = __webpack_require__(87);
	
	var _immutable2 = _interopRequireDefault(_immutable);
	
	var _demoHello = __webpack_require__(98);
	
	var _demoHello2 = _interopRequireDefault(_demoHello);
	
	var _react = __webpack_require__( /*,PropTypes*/8);
	
	var _react2 = _interopRequireDefault(_react);
	
	new _demoHello2['default']().show();
	...
	var TestModel = (function () {
	    ...
	    TestModel = _srcIndexJs.Model(TestModel) || TestModel;
	    return TestModel;
	})();
	
	var TestAction = (function () {
	    function TestAction() {
	        _classCallCheck(this, TestAction);
	    }
	
	    TestAction.prototype.showTest = function showTest() {
	...
	var TestControl = (function (_Action) {
	    _inherits(TestControl, _Action);
	
	    function TestControl() {
	        _classCallCheck(this, _TestControl);
	    ...
	    TestControl.insertTest = function insertTest(path, data) {
	        return this.add(path, data);
	    };
	
	    _createDecoratedClass(TestControl, null, [{
	        key: 'saveTest',
	        decorators: [_srcIndexJs.Sync('/test.json', {
	    ...
	    var _TestControl = TestControl;
	    TestControl = _srcIndexJs.Control(TestModel)(TestControl) || TestControl;
	    return TestControl;
	})(_libBaseAction2['default']);
	...
	var TestComponent = (function (_Component) {
	    ...
	    TestComponent.prototype.componentDidMount = function componentDidMount() {
	        var _this = this;
	
	        setTimeout(function () {
	            _this.props.saveTest(_this);
	            _this.props.insertTest('xq.test.name', 'insert-xiaomin');
	        }, 1000);
	    };
	    ...
	    TestComponent = _srcIndexJs.View(TestControl)(TestComponent) || TestComponent;
	    return TestComponent;
	})(_react.Component);
	
	_srcIndexJs.page(TestComponent);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _gfsReactTools = __webpack_require__(7);
	...
	exports.Sync = _control.Sync;
	exports.fetch = _control.fetch;
	...
	function page() {
	    ...
	    if (opts.debug || location.hostname == 'localhost') {
	        opts.middleware.push(__webpack_require__(91)());
	    }
	
	    var rtools = new _gfsReactTools2['default'](_extend2['default']({
	        //可选
	        middleware: [],
	        //必填
	        module: null,
	        //可选
	        reducers: _model.getModels(),
	        //可选n
	        //devTools:DevTools,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _gfsReduxBindReact = __webpack_require__(11);
	
	var _gfsLoadingbarLibIndexReact = __webpack_require__(61);
	
	var _gfsFetch = __webpack_require__(76);
	
	var _gfsFetch2 = _interopRequireDefault(_gfsFetch);
	
	var _gfsMock = __webpack_require__(82);
	
	var _gfsMock2 = _interopRequireDefault(_gfsMock);
	
	var loadingbar = new _gfsLoadingbarLibIndexReact.LoadingBar();
	var mock = new _gfsMock2['default']();
	
	_gfsFetch2['default'].addMock(mock).addLoadingBar(loadingbar);
	...
	var RTools = (function () {
	    function RTools() {
	        var props = arguments.length <= 0 || arguments[0] === undefined ? {
	            ...
	            reducers: [],
	            devTools: null,
	            bar: _gfsLoadingbarLibIndexReact.LoadingBarComponent,
	            //pc or wap or other
	            agent: 'other',
	            container: 'root'
	        } : arguments[0];
	
	        _classCallCheck(this, RTools);
	        ...
	        if (props.agent === 'pc') {
	            Bar = _react2['default'].createElement(_gfsLoadingbarLibIndexReact.LoadingBarComponent, null);
	        } else if (props.agent === 'wap') {
	            Bar = _react2['default'].createElement(_gfsLoadingbarLibIndexReact.MaskBarComponent, null);
	        }
	
	        _reactDom.render(_react2['default'].createElement(
	            _gfsReduxBindReact.BindReact,
	            { module: props.module, reducers: _extends({}, props.reducers, { fetching: _gfsLoadingbarLibIndexReact.fetching }), middleware: [_gfsLoadingbarLibIndexReact.FetchMiddleware].concat(props.middleware), devTools: props.devTools },
	            _react2['default'].createElement(
	                _gfsLoadingbarLibIndexReact.Connect,
	                null,
	                Bar
	            )
	    ...
	    RTools.fetch = function fetch(url, options) {
	        return _gfsFetch2['default'].run(url, options);
	    };
	
	    RTools.addLoadingBar = function addLoadingBar(loadingbar) {
	        _gfsFetch2['default'].addLoadingBar(loadingbar);
	    };
	
	    RTools.addMock = function addMock(mock) {
	        _gfsFetch2['default'].addMock(mock);
	    };
	
	    return RTools;
	})();
	
	exports['default'] = RTools;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	"use strict";
	var BindReact_1 = __webpack_require__(12);
	exports.BindReact = BindReact_1["default"];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var redux_thunk_1 = __webpack_require__(60);
	var BindReact = (function (_super) {
	    __extends(BindReact, _super);
	    function BindReact() {
	        return _super.apply(this, arguments) || this;
	    }
	    BindReact.prototype.show = function (dispatch, Dev) {
	        var Module = this.props.module;
	        return (React.createElement("div", null,
	            React.createElement(Module, { dispatch: dispatch }),
	            Dev ? React.createElement(Dev, null) : '',
	            this.props.children));
	    };
	    BindReact.prototype.render = function () {
	        var _a = this.props, reducers = _a.reducers, _b = _a.middleware, middleware = _b === void 0 ? [] : _b, devTools = _a.devTools;
	        ...
	        if (devTools) {
	            createStoreWithMiddleware = redux_1.compose(
	            // add middleware ahead
	            redux_1.applyMiddleware.apply(void 0, middlewareList), 
	            // start dev-tools
	            devTools.instrument());
	        }
	        else {
	            createStoreWithMiddleware = (redux_1.applyMiddleware.apply(void 0, middlewareList));
	        }
	        // just use like as createStore()
	        var app = redux_1.combineReducers(__assign({}, reducers));
	        var store = createStoreWithMiddleware(redux_1.createStore)(app);
	        // add dispatch attribute to window
	        window['dispatch'] = this.dispatch = store.dispatch;
	        return (React.createElement(react_redux_1.Provider, { store: store }, this.show(this.dispatch, devTools)));
	    };
	    return BindReact;
	}(React.Component));
	exports.__esModule = true;
	exports["default"] = BindReact;
	//# sourceMappingURL=BindReact.js.map
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mapDispatchToProps = __webpack_require__(32);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var LoadingBar_1 = __webpack_require__(66);
	exports.LoadingBarComponent = LoadingBar_1["default"];
	var LoadingBar_2 = __webpack_require__(66);
	exports.LoadingBar = LoadingBar_2.LoadingBar;
	var MaskBar_1 = __webpack_require__(70);
	exports.MaskBarComponent = MaskBar_1["default"];
	var fetching_1 = __webpack_require__(73);
	exports.fetching = fetching_1.fetching;
	var FetchMiddleware_1 = __webpack_require__(74);
	exports.FetchMiddleware = FetchMiddleware_1["default"];
	var Connect_1 = __webpack_require__(75);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".gfs-loadingbar {\n  position: fixed;\n  z-index: 9000;\n  opacity: 1;\n  display: none;\n  top: 0;\n  left: -6px;\n  height: 2px;\n  width: 1%;\n  background: #b91f1f;\n  border-radius: 1px;\n  -webkit-border-radius: 1px;\n  -moz-border-radius: 1px;\n  transition: all 500ms ease-in-out;\n  -moz-transition: all 500ms ease-in-out;\n  -webkit-transition: all 500ms ease-in-out;\n}\n.gfs-loadingbar:before {\n  opacity: 0.6;\n  width: 180px;\n  right: -80px;\n  display: block;\n  clip: rect(-6px, 90px, 14px, -6px);\n}\n.gfs-loadingbar:after {\n  opacity: 0.6;\n  width: 20px;\n  right: 0;\n  z-index: 8999;\n  clip: rect(-6px, 22px, 14px, 10px);\n}\n.gfs-loadingbar:after,\n.gfs-loadingbar:before {\n  content: ' ';\n  display: block;\n  position: absolute;\n  top: 0;\n  height: 2px;\n  -moz-box-shadow: #b91f1f 1px 0 6px 1px;\n  -ms-box-shadow: #b91f1f 1px 0 6px 1px;\n  -webkit-box-shadow: #b91f1f 1px 0 6px 1px;\n  box-shadow: #b91f1f 1px 0 6px 1px;\n  -moz-border-radius: 100%;\n  -webkit-border-radius: 100%;\n  border-radius: 100%;\n}\n.gfs-loadingbar-mask {\n  display: none;\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  z-index: 1000;\n  background-color: rgba(0, 0, 0, 0.5);\n}\n.gfs-loadingbar-mask .gfs-content {\n  white-space: nowrap;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  text-align: center;\n  padding: 15px 15px;\n  border-radius: 5px;\n  -moz-border-radius: 5px;\n  -webkit-border-radius: 5px;\n  background-color: rgba(0, 0, 0, 0.8);\n  color: #fff;\n  transform: translate(-50%, -50%);\n  -ms-transform: translate(-50%, -50%);\n  -webkit-transform: translate(-50%, -50%);\n}\n.gfs-loadingbar-progress {\n  width: 100%;\n  height: 100%;\n  background: #e2e2e2;\n  border-radius: 40px;\n  -webkit-border-radius: 40px;\n  -moz-border-radius: 40px;\n  overflow: hidden;\n  text-align: center;\n  color: #fff;\n  font-size: 12px;\n  position: relative;\n  vertical-align: middle;\n}\n.gfs-loadingbar-progress:before {\n  position: absolute;\n  width: 1%;\n  height: 100%;\n  background: #b91f1f;\n  content: ' ';\n  display: block;\n  transition: all 500ms ease-in-out;\n  -moz-transition: all 500ms ease-in-out;\n  -webkit-transition: all 500ms ease-in-out;\n  background-color: #de3c26;\n  background-image: -webkit-gradient(linear, left top, left bottom, from(#bd2d30), to(#ff4b1c));\n  background-image: -webkit-linear-gradient(top, #bd2d30, #ff4b1c);\n  background-image: -moz-linear-gradient(top, #bd2d30, #ff4b1c);\n  background-image: -o-linear-gradient(top, #bd2d30, #ff4b1c);\n  background-image: -ms-linear-gradient(top, #bd2d30, #ff4b1c);\n  background-image: linear-gradient(top, #bd2d30, #ff4b1c);\n  filter: progid:DXImageTransform.Microsoft.gradient(GradientType=0, StartColorStr='#bd2d30', EndColorStr='#ff4b1c');\n}\n.gfs-loadingbar-progress span {\n  position: relative;\n}\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Bar_1 = __webpack_require__(67);
	...
	var LoadingBar = (function (_super) {
	    ...
	    function LoadingBar(options) {
	        if (options === void 0) { options = { bar: null }; }
	        var _this = _super.call(this, options) || this;
	        _this.bar = options.bar || null;
	        return _this;
	    }
	    LoadingBar.prototype.run = function (props) {
	        ...
	        if (fetching === 0) {
	            getDispatch()({
	                ...
	                show: this.bar ? this.bar.show : function () { }
	            });
	        }
	        fetching += 1;
	    };
	    LoadingBar.prototype.end = function () {
	        ...
	        if (fetching === 0) {
	            getDispatch()({
	                type: 'fetch_end',
	                hide: this.bar ? this.bar.hide : function () { }
	            });
	        }
	    };
	    return LoadingBar;
	 ...
	 */
	var LoadingBarComponent = (function (_super) {
	    __extends(LoadingBarComponent, _super);
	    //bar:Bar;
	    ...
	    LoadingBarComponent.prototype.isShow = function () {
	        var _a = __assign({}, this.state).display, display = _a === void 0 ? '' : _a;
	        return display == '' || display.toLowerCase() == 'block';
	    };
	    LoadingBarComponent.prototype.show = function () {
	        var _this = this;
	        this.setState({
	            display: 'block'
	        });
	    ...
	    LoadingBarComponent.prototype.hide = function () {
	        this.setState({
	            display: 'none',
	            width: 0
	        });
	    };
	    LoadingBarComponent.prototype.setProgress = function () {
	        //(50 + Math.random() * 30)
	        var p = this.state.width + (50 + Math.random() * 30);
	    ...
	    LoadingBarComponent.prototype.componentWillReceiveProps = function (nextProps) {
	        var _this = this;
	    ...
	    LoadingBarComponent.prototype.componentDidMount = function () {
	        if (this.props.fetching) {
	            this.show();
	        }
	    };
	    LoadingBarComponent.prototype.render = function () {
	        return (React.createElement("div", { className: "gfs-loadingbar", style: {
...
/***/ (function(module, exports) {
	...
	var Bar = (function () {
	    ...
	    Bar.prototype.resetPercentage = function () {
	        this.percentage = 0;
	    };
	    Bar.prototype.progress = function (p) {
	        //更新进度条状态
	        this.setPercentage(p);
	    };
	    Bar.prototype.restart = function () {
	        this.resetPercentage();
	        this.run(0);
	    };
	    Bar.prototype.setFetchStatus = function (status) {
	        this.fetchStatus = this.fetchStatus + status;
	    };
	    Bar.prototype.getFetchStatus = function () {
	        return this.fetchStatus;
	    };
	    Bar.prototype.setPercentage = function (percentage) {
	        var _this = this;
	        //todo 设置进度条宽度
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../css-loader/index.js!../../less-loader/index.js!./loadingbar.less", function() {
				var newContent = require("!!../../css-loader/index.js!../../less-loader/index.js!./loadingbar.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MaskBarComponent = (function (_super) {
	    __extends(MaskBarComponent, _super);
	    function MaskBarComponent(props) {
	        return _super.call(this, props) || this;
	    }
	    MaskBarComponent.prototype.render = function () {
	        return (React.createElement("div", { className: "gfs-loadingbar-mask", style: {
	                display: this.state.display
	            } },
	            React.createElement("div", { className: "gfs-content" }, this.props['message'] || '加载中...')));
	    };
	    return MaskBarComponent;
	}(LoadingBar_1["default"]));
	exports.__esModule = true;
	exports["default"] = MaskBarComponent;
	//# sourceMappingURL=MaskBar.js.map
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../css-loader/index.js!../../less-loader/index.js!./loadingbar-mask.less", function() {
				var newContent = require("!!../../css-loader/index.js!../../less-loader/index.js!./loadingbar-mask.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".gfs-loadingbar-mask {\n  display: none;\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  z-index: 1000;\n  background-color: rgba(0, 0, 0, 0.5);\n}\n.gfs-loadingbar-mask .gfs-content {\n  white-space: nowrap;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  text-align: center;\n  padding: 15px 15px;\n  border-radius: 5px;\n  -moz-border-radius: 5px;\n  -webkit-border-radius: 5px;\n  background-color: rgba(0, 0, 0, 0.8);\n  color: #fff;\n  transform: translate(-50%, -50%);\n  -ms-transform: translate(-50%, -50%);\n  -webkit-transform: translate(-50%, -50%);\n}\n", ""]);
...
/***/ (function(module, exports) {
	...
	var win;
	win = window;
	function fetchgMiddleware(store) {
	...
	exports.__esModule = true;
	exports["default"] = fetchgMiddleware;
	;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Fetch_1 = __webpack_require__(77);
	var fetchObj;
	if (!fetchObj)
	    fetchObj = new Fetch_1["default"](null, null);
	exports.__esModule = true;
	exports["default"] = fetchObj;
	var Fetch_2 = __webpack_require__(77);
	exports.Fetch = Fetch_2["default"];
	//# sourceMappingURL=index.js.map
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Fetch = (function () {
	     ...
	     * */
	    function Fetch(mock, loadingBar) {
	        this.mock = mock;
	    ...
	    Fetch.prototype.addLoadingBar = function (loadingBar) {
	        this.loadingBar = loadingBar;
	        return this;
	    };
	    Fetch.prototype.addMock = function (mock) {
	        this.mock = mock;
	        return this;
	    };
	    Fetch.prototype.fetch = function (url, params, success, error, opts) {
	        //todo 需要处理是否加载loadingbar的逻辑
	        var _this = this;
	        this.loadingBar.run(opts || {});
	        //todo 处理是否是走的mock链接
	        opts.success = function (data, xhr) {
	            _this.loadingBar.end();
	        ...
	        opts.data = params;
	        return new Request_1["default"]().fetch(this.mock.getUrl(url), opts);
	    };
	    /**
	     * 执行异步操作
	     ...
	     * @return promise
	     * */
	    Fetch.prototype.run = function (url, options) {
	        ...
	        return new es6_promise_1.Promise(function (resolve, reject) {
	            _this.fetch(url, options.body, function (data, xhr) {
	                resolve(data, xhr);
	            }, function (xhr) {
	                reject(xhr);
	            }, options);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var jqParam = __webpack_require__(79);
	var Request = (function () {
	    ...
	    Request.prototype.noc = function () {
	    };
	    Request.prototype.send = function (url, opts) {
	        if (opts === void 0) { opts = {
	            abort: this.noc,
	            success: this.noc,
	            error: this.noc
	        ...
	        var x = this.getXMLHttpRequest(), _this = this;
	    ...
	    Request.prototype.fetch = function (url, opts) {
	        //let param = {};
	        /*if(this.isMock() ){
...
/***/ (function(module, exports) {
	...
	var Mock = (function () {
	    ...
	    Mock.prototype.isLocal = function () {
	        return !!this.getEnv();
	    };
	    Mock.prototype.getLocalUrl = function (url) {
	     ...
	     * 获取最终的url
	     * */
	    Mock.prototype.getUrl = function (url) {
	     ...
	     * 获取环境变量
	     * */
	    Mock.prototype.getEnv = function () {
	        var location = window.location, isLocal = this.localReg.test(location.host) && location.href.indexOf('8080') < 0;
	        var field = (isLocal || (location.search && location.search.match('mock=1') != null));
	        return field ? 1 /* 'Dev' */ : 0 /* 'Pro' */; //env[field ];
	    };
	    return Mock;
	}());
	exports.__esModule = true;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _gfsReactReduxTwowayBinding = __webpack_require__(84);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	"use strict";
	var bindingMixin_1 = __webpack_require__(85);
	exports.bindingMixin = bindingMixin_1["default"];
	var createReducer_1 = __webpack_require__(86);
...
/***/ (function(module, exports) {
	...
	;
	//# sourceMappingURL=bindingMixin.js.map
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 * @class Control
	 * */
	var fetch = _gfsReactTools2['default'].fetch;
	exports.fetch = fetch;
	var controlList = {};
	//todo 异步action和数据实现
	//todo 异步ajax中间件
	var curl = {
	    ...
	    del: function del(path, data) {
	        ...
	        var modelName = arguments.length <= 2 || arguments[2] === undefined ? this.__modelName : arguments[2];
	
	        path = path.indexOf('.') >= 0 ? path.split('.') : Array.prototype.concat.call([], path);
	
	        return function (dispatch) {
	            dispatch({
	                type: _this.getModelName('del', true, modelName), //`${DEFAULT}${DEFAULT_METHOD_FIX}${modelName}${DEFAULT_METHOD_FIX}del`,
	                path: path,
	                data: data
	            });
	        };
	    ...
	    update: function update(path, data) {
	        ...
	        return function (dispatch) {
	            dispatch({
	                type: _this2.getModelName('update', true, modelName), //`${DEFAULT}${DEFAULT_METHOD_FIX}${modelName}${DEFAULT_METHOD_FIX}update`,
	                path: path,
	                data: data
	            });
	        };
	    ...
	    add: function add(path, data) {
	        ...
	        var modelName = arguments.length <= 3 || arguments[3] === undefined ? this.__modelName : arguments[3];
	        ...
	        return function (dispatch) {
	            dispatch({
	                type: _this3.getModelName('update', true, modelName), //`${DEFAULT}${DEFAULT_METHOD_FIX}${modelName}${DEFAULT_METHOD_FIX}update`,
	                path: path,
	                data: data,
	    ...
	    save: function save(path, data) {
	        ...
	        return function (dispatch) {
	            dispatch({
	                type: _this4.getModelName('save', true, modelName), //`${DEFAULT}${DEFAULT_METHOD_FIX}${modelName}${DEFAULT_METHOD_FIX}save`,
	                path: path.indexOf('.') >= 0 ? path.split('.') : Array.prototype.concat.call([], path),
	                data: data,
	                isImmutable: isImmutable
	            });
	...
	function Sync(anywhere) {
	    ...
	    return function (target, name, descriptor) {
	        ...
	        var fn = (function () {
	            var success = arguments.length <= 0 || arguments[0] === undefined ? function () {} : arguments[0];
	            ...
	            return function () {
	                ...
	                return function (dispatch) {
	                    ...
	                    if (url) {
	                        fetch(url, _extend2['default'](opts, methodArg.url || methodArg.body ? methodArg : {})).then(function () {
	                            var result = fn.apply(target, Array.prototype.slice.call(arguments).concat(args));
	                            if (result instanceof Function) {
	                                result(dispatch);
	                            } else if (result && typeof result === 'object') {
	                                dispatch(_extend2['default'](result || {}, {
	                                    type: '' + target.__modelName + _model.DEFAULT_METHOD_FIX + (result.type ? result.type : name),
	...
	function Control(model, loadingbar, mock) {
	    if (model === undefined) model = {};
	
	    if (arguments.length === 2) {
	        _gfsReactTools2['default'].addLoadingBar(loadingbar);
	    }
	
	    if (arguments.length === 3) {
	        _gfsReactTools2['default'].addMock(mock);
	    }
	    ...
	    return function (target) {
	        ...
	        target.getModelName = function () {
	            ...
	            var modelName = arguments.length <= 2 || arguments[2] === undefined ? target.__modelName : arguments[2];
	
	            return '' + (isDefault ? _model.DEFAULT + _model.DEFAULT_METHOD_FIX : '') + modelName + _model.DEFAULT_METHOD_FIX + actionName;
	        };
	        return model;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _diff = __webpack_require__(94);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _deepDiff = __webpack_require__(95);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _aspect = __webpack_require__(99);
	...
	var Hello = (function () {
	    ...
	    _createDecoratedClass(Hello, [{
	        key: 'show',
	        decorators: [_aspect2['default']('before', function () {
	            console.log('-------before 2---------');
	        }), _aspect2['default']('before', function () {
	            console.log('-------before---------');
	        }), _aspect2['default']('after', function () {
	            console.log('-------after---------');
	        })],
	        value: function show() {
	            //do something
...
/***/ (function(module, exports) {
	...
	function aspect(type, fn, fn2) {
	    return function (target, name, descriptor) {
	        type = type.toLowerCase();
	        var f = (function (currentMethod) {
	            var c = currentMethod;
	            switch (type) {
	                //环绕
	                case 'around':
